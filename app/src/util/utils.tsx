...
export interface ChainState {
  ...
  stakeBaseBalance: BigNumber,
  stakeQuoteBalance: BigNumber,
  incentiveTotalBaseBalance: BigNumber,
  incentiveTotalQuoteBalance: BigNumber,
}
...
export function tokenQtyToNumber(x: BigNumber, decimals: number): number {
  const divided = x.div(BigNumber.from(10).pow(decimals - 5));

  return divided.toNumber() / 100000;
}
