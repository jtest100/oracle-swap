...
contract OracleSwapTest is Test {
    ...
    function testBuy() public {
        ...
        assertEq(swap.buyFee(), 10e18 * 3 / 1000);
        assertEq(quoteToken.balanceOf(address(this)), 10e18 - 1 - 10e18 * 3 / 1000);
    ...
    function testSell() public {
        ...
        assertEq(swap.sellFee(), 10e18 * 3 / 1000);
        assertEq(quoteToken.balanceOf(address(this)), 30e18 - 10e18 * 3 / 1000);
